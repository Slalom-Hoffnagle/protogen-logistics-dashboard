...
const summaryCards = computed(() => [
  { label: 'Revenue', value: formatCurrency(totals.value.revenue), icon: 'mdi-currency-usd', color: 'teal' },
  { label: 'On-time percentage', value: `${totals.value.onTime.toFixed(1)}%`, icon: 'mdi-clock-check-outline', color: 'cyan' },
